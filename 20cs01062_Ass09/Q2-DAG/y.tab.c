...
#line 49 "DAG.y"
         { 
            char temp[100];
            sprintf(temp,"%s + %s", (yyvsp[-2].Node)->expression, (yyvsp[0].Node)->expression);
        
            node *PlusNode = processOperationNode(temp, 1, '+', (yyvsp[-2].Node), (yyvsp[0].Node));
            (yyval.Node) = PlusNode; 
...
#line 57 "DAG.y"
         { 
            ...
            node *MinusNode = processOperationNode(temp, 1, '-', (yyvsp[-2].Node), (yyvsp[0].Node));
...
#line 67 "DAG.y"
         {  
            ...
            node *MulNode = processOperationNode(temp, 1, '*', (yyvsp[-2].Node), (yyvsp[0].Node));
            (yyval.Node) = MulNode; 
...
#line 75 "DAG.y"
         { 
            ...
            node *DivNode = processOperationNode(temp, 1, '/', (yyvsp[-2].Node), (yyvsp[0].Node));
            (yyval.Node) = DivNode; 
...
#line 83 "DAG.y"
         { 
            ...
            node *ModNode = processOperationNode(temp, 1, '%', (yyvsp[-2].Node), (yyvsp[0].Node));
            (yyval.Node) = ModNode; 
...
#line 93 "DAG.y"
        { 
            char temp[100];
            sprintf(temp,"%c", (yyvsp[0].Value));
            
            node *IDNode = processOperationNode(temp, 0, (yyvsp[0].Value), NULL, NULL);
            (yyval.Node) = IDNode; 
